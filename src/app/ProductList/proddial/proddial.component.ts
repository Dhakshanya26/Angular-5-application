...
@Component({
  ...
  templateUrl: './proddial.component.html',
  styleUrls: ['./proddial.component.scss']
})
export class ProddialComponent  {
  ...
  constructor(public dialogRef: MatDialogRef<ProddialComponent>, @Inject(MAT_DIALOG_DATA) inputData,
    private fb: FormBuilder, private _router: Router,private _productservice: UserService ) {
    var data = inputData;
